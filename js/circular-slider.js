(function () {
  ...
  Slider.prototype.setSize = function (radius) {
    let r = 1.2 * radius * (1 - this.startSetup.slideSize);
    this.slidesHolder.style.width = this.slidesHolder.style.height = r + "px";
    this.slidesHolder.style.borderWidth = 0.38 * r + "px";
  ...
  Slider.prototype.slidesRepositioning = function (r) {
    for (let i = 0; i < this.slides.length; i++) {
      let x = (r - (40 / 100) * r) * Math.cos(this.stepAngle * i - Math.PI / 4),
        y = (r - (40 / 100) * r) * Math.sin(this.stepAngle * i - Math.PI / 4);
